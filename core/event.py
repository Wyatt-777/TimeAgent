...
class EventType(str, Enum):
    ...
    CODEX_SESSION_FINISHED = "CODEX_SESSION_FINISHED"
    CODEX_TURN_STARTED = "CODEX_TURN_STARTED"
    CODEX_TOOL_ACTIVITY = "CODEX_TOOL_ACTIVITY"
    CODEX_TURN_FINISHED = "CODEX_TURN_FINISHED"
    CODEX_COMPACTION = "CODEX_COMPACTION"
    CODEX_SUBAGENT_ACTIVITY = "CODEX_SUBAGENT_ACTIVITY"
